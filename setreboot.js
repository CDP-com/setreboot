//
// setreboot.js
// Summary: ( OTM App ) allows OTM users... .
// Icon: setreboot.jpg
//

var ManVer = "1438268272915";
function GetManVer(){ return ManVer; }

var strFileURL = "http://snapback-apps.com/setreboot/setreboot1438268272915.cdpupdate";
function GetstrFileURL(){ return strFileURL; }

var strOnlineURL = "http://snapback-apps.com/setreboot/invis.gif";
function GetstrOnlineURL(){ return strOnlineURL; }

var SyncCookieName = "setrebootpckgid";
function GetSyncCookieName(){ return SyncCookieName; }

// the following variables are defined outside the scope of this template:
// http://snapback-apps.com/setreboot/setreboot.xml
// %ALLUSERSPROFILE%\\cdp\\snapback\\apps\\setreboot\\setreboot.xml
// http://snapback-apps.com/setreboot/index.html
// index.html
// http://snapback-apps.com/setreboot/ax/CDPUpdater.cab
// soon:-1,-1,-1,-1

var ManifestFile = "setreboot.xml"
function GetManifestFile() { return ManifestFile; }

var ManifestURL_Remote = "http://snapback-apps.com/setreboot/setreboot.xml";
function GetManifestURL_Remote(){ return ManifestURL_Remote; }

var ManifestURL_Local = "%ALLUSERSPROFILE%\\cdp\\snapback\\apps\\setreboot\\setreboot.xml";
function GetManifestURL_Local(){ return ManifestURL_Local; }

var StartUrl_Remote = "http://snapback-apps.com/setreboot/index.html";
...
function switchToLocal()
{
    ...
    {
        output = doCommand2( "takemelocal" + "," + "\"" + escape("%ALLUSERSPROFILE%\\cdp\\setreboot\\startmom.vbs") + "\"" );
    }
